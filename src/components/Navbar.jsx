...
export default function Navbar() {
  ...
  const handleNavClick = (e, href) => {
    ...
    if (open) {
      // let the mobile menu's collapse animation finish first — its layout
      // changes cancel an in-progress smooth scroll if started concurrently
      setOpen(false);
    ...
    >
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-5">
        <a
          ...
          className="font-hand text-2xl font-semibold text-[var(--color-violet)]"
        >
          AK
        </a>
